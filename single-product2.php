                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="product-images">
                                    <div class="product-main-img">
                                        <a href="img/p2-1.png" target="_blank"><img src="img/p2-1.png" alt=""></a>
                                    </div>
                                    
                                    <div class="product-gallery">
                                        <a href="img/p2-2.png" target="_blank"><img src="img/p2-2.png" alt=""></a>
                                        <a href="img/p2-3.png" target="_blank"><img src="img/p2-3.png" alt=""></a>
                                        <a href="img/p2-4.png" target="_blank"><img src="img/p2-4.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    <h2 class="product-name">IPhone 13 Pro Max</h2>
                                    ...
                                    <div role="tabpanel">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="home">
                                                ...
                                                <p>Màn hình: 6.7 inches (1284 x 2778 pixels), tỷ lệ 19.5:9</p>
                                                <p>Hệ điều hành: iOS 15</p>
                                                <p>Camera sau: 12 MP, f/1.5, 26mm (góc rộng), dual pixel PDAF, sensor-shift OIS</p>
                                                <p>Camera trước: 12 MP, f/2.2, 23mm (góc rộng)</p>
                                                <p>CPU: Apple A15 Bionic (5 nm)</p>
                                                <p>RAM: 6GB</p>
                                                <p>Bộ nhớ trong: 128GB-1TB NVMe</p>
                                                <p>Thẻ SIM: 2 SIM (1 eSIM)</p>
                                                <p>Dung lượng pin: Li-Ion 4352 mAh</p>
                                                <p>Thiết kế: Thanh + cảm ứng</p>
