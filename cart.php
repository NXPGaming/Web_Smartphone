        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><a href=<?php $s = "cart.php"; if ($customerID != 0) {
                            $s .= "?customerID={$customerID}&orderCode={$orderCode}";}
                            echo $s;?>><i class="fa fa-user"></i> My Cart</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href=<?php $s = "cart.php"; if ($customerID != 0) {
                            $s .= "?customerID={$customerID}&orderCode={$orderCode}";}
                            echo $s;?>>Cart - <span class="cart-amunt">
                            <?php echo $total ?> ₫
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a href=<?php $s= "home.php";if ($customerID != 0) {
                            $s .= "?customerID={$customerID}&orderCode={$orderCode}";}
                            echo $s;
                        ?>>Home</a></li>
                        <li><a href=<?php $s= "shop.php";if ($customerID != 0) {
                            $s .= "?customerID={$customerID}&orderCode={$orderCode}";}
                            echo $s;
                        ?>>Shop page</a></li>
                        <li class="active"><a href=<?php $s= "cart.php";if ($customerID != 0) {
                            $s .= "?customerID={$customerID}&orderCode={$orderCode}";}
                            echo $s;
                        ?>>Cart</a></li>
                        <li><a href=<?php $s= "checkout.php";if ($customerID != 0) {
                            $s .= "?customerID={$customerID}&orderCode={$orderCode}";}
                            echo $s;
                        ?>>Checkout</a></li>
                ...
                <div class="col-md-4">
                        ...
                        <?php while($row = $result->fetch_assoc()) { ?>
                            <?php if($row['productID'] >4 and $row['productID'] <9) { ?>
                                ...
                                ?> >
                                    ...
                                    <h2><a href=<?php $s = "single-product.php?myNumber={$row['productID']}";
                                if ($customerID != 0) {
                                    $s .= "&customerID={$customerID}&orderCode={$orderCode}";}
                                echo $s;
                                ?> ><?php echo $row['productName'] ?></a></h2>
                    ...
                    <div class="single-sidebar">
                        ...
                        <?php while($row = $result->fetch_assoc() and $row['productID'] <5) { ?>
                            <ul>
                                <li><a href=<?php $s = "single-product.php?myNumber={$row['productID']}";
                                if ($customerID != 0) {
                                    $s .= "&customerID={$customerID}&orderCode={$orderCode}";}
                                echo $s;
                                ?> ><?php echo $row['productName'] ?></a></li>  
                            </ul>
                        <?php } ?>    
                    </div>
                </div>
                                            ...
                                            while($row = $a2->fetch_assoc()) { ?>
                                                <tr class="cart_item">
                                                    <td class="product-remove">
                                                        ...
                                                        href="<?php echo "removePFC.php?customerID={$customerID}&orderCode={$row['orderCode']}&productID={$row['productID']}"?> <?php if ($customerID != 0) {
                            $s .= "&customerID={$customerID}&orderCode={$orderCode}";}?>" >×</a> 
                                                    </td>
                            ...
                            echo "customerID={$customerID}&orderCode={$orderCode}";}?>" >
                                                    ...
                                                    <td class="product-quantity">
                                                        <div class="quantity buttons_added">
                                                            <input type="text" size="1" readonly="readonly" value="<?php echo $row['quantityOrdered'] ?>" >
...
<!--                                         <tr>
                            ...
                            <div class="cart_totals ">
                                ...
                                <table cellspacing="0">
                                    <tbody>
                                        <tr class="cart-subtotal">
                                            <th>Cart Subtotal</th>
                                            <td><span class="amount"><?php echo $cartTotal ?> ₫</span></td>
                                        </tr>
                                ...
                                <a  href=<?php $s =  "checkout.php?";
                            if ($customerID != 0) {
                                $s .= "customerID={$customerID}&orderCode={$orderCode}";}
                            echo $s;
                            ?>> <button style="width: 300px;" type="submit"> CHECKOUT </button> </a>
                            </div>
