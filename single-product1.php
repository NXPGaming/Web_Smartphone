                                    ...
                                    <div role="tabpanel">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="home">
                                                ...
                                                <p>Màn hình: Full HD+ (1080 x 2400 pixels), 20:9 (~398 ppi)</p>
                                                <p>Hệ điều hành: Android 11, Realme UI 2.0</p>
                                                <p>Camera sau: 64 MP, f/1.8 (góc rộng), PDAF</p>
                                                <p>Camera trước: 16 MP, f/2.5, 26mm (góc rộng)</p>
                                                <p>CPU: Qualcomm SM8250-AC Snapdragon 870 5G (7 nm)</p>
                                                <p>RAM: 6-8GB</p>
                                                <p>Bộ nhớ trong: 128-256GB</p>
                                                <p>Thẻ SIM: 2 SIM</p>
                                                <p>Dung lượng pin: Li-Po 5000 mAh</p>
