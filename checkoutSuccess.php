  ...
  <body>
    ...
    <div class="mainmenu-area">
        <div class="container">
            ...
            echo $s;
            ?>>Cart</a></li>
                        <li class="active"><a href=<?php $s =  "checkout.php?";
                            if ($customerID != 0) {
                                $s .= "customerID={$customerID}&orderCode={$orderCode}";}
                            echo $s;
                            ?>>Checkout</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce" style="text-align: center; font-size: 50px;
  /*background-image:  url(https://static.pexels.com/photos/4827/nature-forest-trees-fog.jpeg);p6-3*/
    background-image:  url(./img/p6-3.png);
                        ...
                        <div class="related-products-wrapper">
                            ...
                            echo "customerID={$customerID}&orderCode={$orderCode}";}?>>
                                            ...
                                            <h4 style="width: 210px;text-align: center; padding-top: 10px;">
                                                <a style="width: 210px; text-align: center; font-size: 16px;" href=<?php echo "single-product.php?myNumber={$row['productID']}&"?> <?php if ($customerID != 0) {
                            echo "customerID={$customerID}&orderCode={$orderCode}";}?>>
