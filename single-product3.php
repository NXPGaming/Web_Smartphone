                ...
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        ...
                        <div class="thubmnail-recent">
                            <img src="img/p1-1.png" class="recent-thumb" alt="">
                        ...
                        <div class="thubmnail-recent">
                            <img src="img/p2-1.png" class="recent-thumb" alt="">
                        ...
                        <div class="thubmnail-recent">
                            <img src="img/p4-1.png" class="recent-thumb" alt="">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="product-images">
                                    <div class="product-main-img">
                                        <a href="img/p3-1.png" target="_blank"><img src="img/p3-1.png" alt=""></a>
                                    </div>
                                    
                                    <div class="product-gallery">
                                        <a href="img/p3-2.png" target="_blank"><img src="img/p3-2.png" alt=""></a>
                                        <a href="img/p3-3.png" target="_blank"><img src="img/p3-3.png" alt=""></a>
                                        <a href="img/p3-4.png" target="_blank"><img src="img/p3-4.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    <h2 class="product-name"><?php echo htmlspecialchars($row['productName']) ?>  </h2>
                                    ...
                                    <div role="tabpanel">
                                        ...
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="home">
                                                ...
                                                <p>Màn hình: Dynamic AMOLED, QHD (1440 x 3040 pixels), 6.8 inches, Corning Gorilla Glass 6, HDR10+</p>
                                                <p>Hệ điều hành: Android 9.0 (Pie); One UI</p>
                                                <p>Camera sau: 4 Camera: 12 MP + 12 MP (telephoto) + 16 MP (góc rộng) + TOF 3D VGA camera</p>
                                                <p>Camera trước: 10 MP</p>
                                                <p>CPU: Exynos 9825 (7 nm)</p>
                                                <p>RAM: 12GB</p>
                                                <p>Bộ nhớ trong:    256GB - 512GB</p>
                                                <p>Thẻ SIM: 1 Sim</p>
                                                <p>Dung lượng pin: 4300 mAh, sạc nhanh 45W·</p>
                                                <p>Thiết kế: Thiết kế nguyên khối cứng cáp, Màn hình Fullview</p>
